...
There is another object InventoryManager that contains a C# script component: InventoryManager.cs

The example inventory displayer will be relying on this script to retrieve items as well as organize them into a grid.
