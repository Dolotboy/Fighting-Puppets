// Original Steamworks.NET is Copyright (c) 2013-2019 Riley Labrecque

// Copyright (c) 2022 Brett Arnett (www.fruitripened.com)
// This is not original Steamworks.NET as it has been altered.
...
namespace Steamworks {
	public static class SteamInventory {
		...
		public static bool BrettArnettGetItemIDs(SteamItemDef_t[] pItemDefIDs, ref uint punItemDefIDsArraySize)
		{
			InteropHelp.TestIfAvailableClient();
			if (pItemDefIDs != null && pItemDefIDs.Length != punItemDefIDsArraySize)
			{
